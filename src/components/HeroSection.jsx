...
import { Letter } from "./animation/TextRandomized";
...
const HeroSection = () => {
  ...
  return (
    <section className="h-screen overflow-x-hidden bg-gradient-to-t from-[#FF6774] via-[#FF8F9B] to-[#FFB4BE] relative">
      <div className="w-[90%] mx-auto">
        <div className=" absolute bottom-3">
          ...
          <h1 className="font-manrope  font-extrabold leading-16  lg:mb-0 lg:leading-tight text-[12vw] lg:text-[8vw] text-nowrap text-white text-whitepointer-events-none whitespace-pre-wrap lg:bg-gradient-to-b  from-9c81ff to-white bg-clip-text lg:text-transparent">
