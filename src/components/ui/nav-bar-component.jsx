        ...
        >
          ...
          <div className="flex w-full lg:flex-row justify-between flex-col-reverse lg:ml-10 h-5/6 lg:items-center ">
            <motion.ul
              ...
              variants={liVariant}
            >
              <Link to="https://www.facebook.com/khant.l.nyan.7">
                <FaFacebook
                  color={"rgb(82 82 91)"}
                  className="text-3xl lg:text-4xl"
                />
              </Link>
              <Link to="https://www.instagram.com/linxnext">
                <FaInstagram color={"rgb(82 82 91)"} size={28} />
              </Link>
              <Link to="https://www.linkedin.com/in/khant-lin-nyan-233325287/">
                <FaLinkedin
                  color={"rgb(82 82 91)"}
                  className="text-3xl lg:text-4xl"
                />
              </Link>
              {/* <Link to="https://t.me/+pnU0fIZ6MV5iODE9">
                <FaTelegram
                  color={"rgb(82 82 91)"}
                  className="text-3xl lg:text-4xl"
                />
